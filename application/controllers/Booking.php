...
class Booking extends CI_Controller {
    ...
    public function tambahBooking()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Buku berhasil di tambah ke keranjang</div>');
    ...
    public function hapusbooking()
    {
        ...
        if ($kosong < 1) {
            $this->session->set_flashdata('pesan', '<div class = "alert alert-message alert-danger" role="alert">Maaf, tidak ada buku dikeranjang anda</div>');
            redirect(base_url());
    ...
    public function exportToPdf()
    {
        ...
        include $sroot."/Pustaka-booking-main/application/third_party/dompdf/autoload.inc.php";
