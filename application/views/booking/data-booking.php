        ...
        <table>
            ...
            <tr>
              <td colspan="3">
                ...
                <a href="<?= base_url() . 'booking/bookingSelesai/'. $this->session->userdata('id_user'); ?>" class="btn btn-sm btn-outline-success"><span class="fas fw fa-stop">&nbsp;Selesai Booking</span></a>
              </td>
            </tr>
        </table>
    </center>
